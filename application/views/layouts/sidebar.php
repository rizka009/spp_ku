<!-- Main Sidebar Container -->
	<aside class="main-sidebar sidebar-dark-primary elevation-4">
		...
		<a href="" class="brand-link">
			<img src="<?= base_url('asset/template/') ?>dist/img/ika1.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
					 style="opacity: .8">
		...
		<div class="sidebar">
			...
			<div class="user-panel mt-3 pb-3 mb-3 d-flex">
				<div class="image">
					<img src="<?= base_url('asset/template/') ?>dist/img/ika1.jpg" class="img-circle elevation-2" alt="User Image">
				</div>
				<div class="info">
					<a href="welcome" class="d-block"><?php echo $this->session->userdata('username'); ?></a>
				</div>
			</div>
